...
- [ ] إنشاء مهارة قابلة لإعادة الاستخدام لمسار Lead وCAPI وDedup والتنبيهات
- [x] إضافة حقول حضور الويبنار والتحصيل إلى Google Sheet دون تعديل الصفوف أو الحقول القائمة
- [ ] إعداد تنبيه يومي للرصد القراءة فقط لأخطاء CAPI 4xx/5xx مع إخطار فوري عند وجود خطأ
- [ ] تهيئة متابعة EMQ وDedup في Events Manager وتوثيق تقرير ما بعد 24 ساعة
