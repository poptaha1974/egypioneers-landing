          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-3">
              {[
                ...
                { q: "محتاج رأس مال كبير؟", a: "لا. المنتجات بأسعار أول يد وبتقدر تبدأ بميزانية محدودة. وفيه خيارات تقسيط." },
                { q: "لو مش فاهم حاجة في التسويق؟", a: "عادي. بنبدأ معاك من الصفر وبنعلمك كل حاجة عملياً. وفيه فريق دعم متاح ليك." },
                { q: "المعرض فين؟", a: "فيلا 139 - التجمع الأول - خلف شارع التسعين الجنوبي - أمام مول عبد العزيز ماركتس." },
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 text-white/60 text-sm">
                  ...
                  <span>فيلا 139 - التجمع الأول - خلف التسعين الجنوبي</span>
                </div>
              </div>
            </div>
            <div>
